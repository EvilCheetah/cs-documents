...
\begin{document}
    \begin{tikzpicture}
        % 1. Function F_k1
        \node[text=red] (f1) at (0,-1.5cm) [minimum width=1cm,rounded corners=1ex,draw] {$0000 \XOR 1100$};
        ...
        \node[text=red] (l0) at ($(p0.west)!0.2!(p0.center)$) {$1111$};
        \node[text=red] (r0) at ($(p0.center)!0.8!(p0.east)$) {$0000$};
        ...
        \node (l1) at ($(p1.west)!0.2!(p1.center)$) {$R$};
        \node (r1) at ($(p1.center)!0.5!(p1.east)$) {$L \XOR (R \XOR K')$};
        ...
        % Updated destination coordinate here:
        \draw[-latex] (xor1.south) -- (l0 |- CrossTop) -- (r0 |- CrossBot) -- (r0 |- p1.north);
