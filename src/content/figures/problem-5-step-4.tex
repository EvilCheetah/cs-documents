...
\begin{document}
    \begin{tikzpicture}
        % 1. Function F_k1
        \node[text=red] (f1) at (0,-1.5cm) [minimum width=1cm,rounded corners=1ex,draw] {$1100$};
        ...
        \node (l0) at ($(p0.west)!0.2!(p0.center)$) {$1111$};
        \node (r0) at ($(p0.center)!0.8!(p0.east)$) {$0000$};
        ...
        \node[text=red] (l1) at ($(p1.west)!0.2!(p1.center)$) {$0000$};
        \node[text=red] (r1) at ($(p1.center)!0.575!(p1.east)$) {$1111 \XOR 1100$};
